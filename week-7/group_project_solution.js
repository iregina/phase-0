...
// Person 4: Refactor and Translate to User Stories - Regina Wong
...
// Method 1 - As a user, I want to create a function that adds up all the numbers.
// Method 2 - As a user, I want to create a function that takes the sum of all the numbers and divide by the number of numbers.
// Method 3 - As a user, I want to create a function that sorts all the numbers then identify the median of all the numbers.  
